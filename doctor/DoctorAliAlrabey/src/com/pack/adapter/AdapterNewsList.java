 ...
 * 
 */
public class AdapterNewsList extends ArrayAdapter<NewsObject> {
	Context context;
	 ...
	 * @param items
	 */
	public AdapterNewsList(Context context, int resource,
			ArrayList<NewsObject> news) {
	...
	public View getView(int position, View itemRow, ViewGroup parent) {
		...
		Picasso.with(context)
				...
				.centerCrop().into(img);
		;
		title.setText(news.get(position).getNewsName());
